...
namespace GrapeCityJSDemo.Blazor.Server {
    public partial class GrapeCityJSDemoBlazorApplication : BlazorApplication {
        public GrapeCityJSDemoBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void GrapeCityJSDemoBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
